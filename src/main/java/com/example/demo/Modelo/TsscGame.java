...
public class TsscGame implements Serializable {
	...
	private long id;
	@NotBlank(message = "The administrator password cannot be empty", groups=GameValidated.class)
	@Column(name = "ADMIN_PASSWORD")
	private String adminPassword;
	@NotBlank(message = "The guest password cannot be empty", groups=GameValidated.class)
	@Column(name = "GUEST_PASSWORD")
	private String guestPassword;
	@Min(value = 1, message = "Groups must be greater than zero", groups=GameValidated.class)
	@Column(name = "N_GROUPS")
	private Integer nGroups = 4;
	@Min(value = 1, message = "Sprints must be greater than zero", groups=GameValidated.class)
	@Column(name = "N_SPRINTS")
	private Integer nSprints = 4;
	@NotBlank(message = "The name is empty", groups=GameValidated.class)
	private String name;

	@Column(name = "PAUSE_SECONDS")
	private Long pauseSeconds = 0L;
	@NotNull(message = "You must select a date", groups=GameValidated.class)
	@Column(name = "SCHEDULED_DATE")
	@DateTimeFormat(pattern = "yyyy-MM-dd")
	private LocalDate scheduledDate;
	@NotNull(message = "You must select a time", groups=GameValidated.class)
	...
	@NotBlank(message = "The user password cannot be empty", groups=GameValidated.class)
