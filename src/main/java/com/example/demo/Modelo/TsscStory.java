...
public class TsscStory implements Serializable {
	...
	@Min(value = 1, message ="The business value must be greater than zaro", groups=StoryValidated.class)
	@Column(name = "BUSINESS_VALUE")
	private BigDecimal businessValue;

	private String description;
	@Min(value = 1, message ="The initial sprint value must be greater than zaro", groups=StoryValidated.class)
	@Column(name = "INITIAL_SPRINT")
	private BigDecimal initialSprint;

	@Column(name = "ST_NUMBER")
	private BigDecimal number;
	@Min(value = 1, message ="The priority value must be greater than zaro", groups=StoryValidated.class)
	...
	@NotNull(message = "You must to select a game", groups=StoryValidated.class)
	@ManyToOne
